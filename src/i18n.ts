const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'details_empty_title': 'Add project context',
    'details_empty_desc': 'This is where you describe your project for agents and collaborators. Add a description, link to your repo, list the tech stack, and write context notes — anything an agent needs to pick up work on this project: architecture decisions, API keys location, relevant docs, skills to use.',
    'save': 'Save',
    'cancel': 'Cancel',
  ...
  he: {
    ...
    'details_empty_title': 'הוסיפו הקשר לפרויקט',
    'details_empty_desc': 'כאן מתארים את הפרויקט עבור סוכנים ושותפים. הוסיפו תיאור, קישור למאגר, רשימת טכנולוגיות, והערות הקשר — כל מה שסוכן צריך כדי לעבוד על הפרויקט: החלטות ארכיטקטורה, מיקום מפתחות API, תיעוד רלוונטי, כישורים לשימוש.',
    'save': 'שמירה',
    'cancel': 'ביטול',
